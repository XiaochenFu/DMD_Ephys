...
ParentFolder = 'C:\Users\Fukunaga\Documents\Xiaochen\Code\DMD_ephys';
load([ParentFolder '/F0_Setup/data/' DataFileName])
latenc y = 0.08; % in second
radius = 500;
side_length = 50;
...
darkTime        = latency*1000000;    % dark time after exposure in �s
